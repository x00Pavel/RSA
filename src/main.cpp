...
int main(int argc, char *const argv[]) {
    ...
    switch (getopt(argc, argv, ":e:d:b:g:h")) {
        case 'g': {
            ...
            cout << "0x" << params->p.get_str(16) << " 0x"
                 << params->q.get_str(16) << " 0x" << params->n.get_str(16)
                 << " 0x" << params->e.get_str(16) << " 0x"
                 << params->d.get_str(16) << endl;
            break;
        }
        case 'e': {
            ...
            mpz_class cypher =
                encrypt(e_.get_mpz_t(), n_.get_mpz_t(), msg.get_mpz_t());
        ...
        case 'd': {
            ...
            mpz_class text =
                decrypt(d_.get_mpz_t(), n_.get_mpz_t(), msg.get_mpz_t());
        ...
        case 'b': {
            ...
            r->seed(time(nullptr));
            mpz_class factor_PollardRho = PollardRho_factorisation(n_, r);

            cout << "0x" << factor_PollardRho.get_str(16) << endl;
